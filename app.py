...
if selected_kecamatan == "":
    ...
    # Membuat DataFrame untuk total suara per kandidat (dimana setiap kandidat adalah satu kolom)
    totals = pd.DataFrame({
    ...
    # Menggunakan st.line_chart untuk menampilkan 4 garis per kandidat
